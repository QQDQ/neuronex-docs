...
- [Kafka](./kafka/overview.md): Kafka is a distributed streaming processing platform. The NeuronEX Kafka plugin enables users to publish collected data to Kafka for further processing.